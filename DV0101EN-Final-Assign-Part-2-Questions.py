...
value='Select Statistics',
            ...
            style={'textAlignLast': 'center', 'width': '80%', 'padding': '3px', 'fontSize': '20px' }
        )
    ]),
    ...
    # Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
                    figure=px.pie(exp_rec,
                        ...
                        names='Vehicle_Type',
                        title="Expenditure for each Vehicle type during Recession"
                )
        )
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title="Yearly Automobile Sales fluctuation for Whole Period {}".format(input_year)))
...
#port=int(os.getenv('PORT', 8050)) # you can change to 8060
# Run the Dash app
